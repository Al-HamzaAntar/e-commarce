...
export default function HeroItemsCreate() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="إضافة عنصر بطولي جديد" />
            <div className="flex h-full flex-1 flex-col gap-6 p-4 sm:p-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight">إضافة عنصر بطولي جديد</h1>
                        <p className="text-muted-foreground mt-1 text-sm">أضف عنصر جديد للقسم البطولي في الصفحة الرئيسية</p>
                    </div>
                </div>
